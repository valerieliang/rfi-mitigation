...
def process_rfi(cfg: Struct, raw_data: np.ndarray,
    ...
    if opt.mitigation_algorithm == "ST-EVD":
        ...
        rfi_likelihood = isce3.signal.rfi_process_evd.run_slow_time_evd(
            ...
            num_rfi_buffer=opt_evd.num_rfi_buffer,
            ...
            swaths=swaths,
            threshold_method=opt_evd.threshold_method,
            rfi_check=opt_evd.rfi_check,
            bt_cond_num_std_thresh_db=opt_evd.bt_cond_num_std_thresh_db,
            max_ev_spread_thresh_db=opt_evd.max_ev_spread_thresh_db,
            eff_rank_std_thresh=opt_evd.eff_rank_std_thresh,
            pwr_ref_percentile=opt_evd.pwr_ref_percentile,
            pwr_upper_percentile=opt_evd.pwr_upper_percentile,
            sig_ev_margin_db=opt_evd.sig_ev_margin_db,
            rfi_candidate_tolerance_db=opt_evd.rfi_candidate_tolerance_db,
