#!/usr/bin/env python
"""
score_unet_remote.py

Script designed to run on the ISCE3 server where PyTorch is available.
Run a PRETRAINED UNet segmentation model on real NISAR L0B tiles with NO LABELS.

This produces visualizations similar to score_scene.py:
  ...
  4. SAVED PREDICTIONS - HDF5 file with per-tile predictions for later analysis

Usage:
    # On isce3 server:
    python score_unet_remote.py \\
        --tiles /path/to/raw_tiles_A_HH.h5 \\
        --model /path/to/best_model.pth \\
        --output-dir results/unet_scene_A_HH

    # Then download results to local machine for viewing
