# HV Polarization - Los Angeles Region Focused Plots
...
- **Original RFI CPIs**: 1,029,103 (99.98%)
- **Recovered CPIs** (knee_bound=4): 196,598 (19.10%)
- **Remaining RFI CPIs**: 832,505 (80.88%)

## How to Regenerate

```bash
cd full_nisar_streaming/results/los_angeles/hv
python ../../../plot_nisar_predictions.py hv_outputs.h5 --knee-bound 4 --la-only --output-dir focused_image --prefix knee_la
```
...
## Comparison with HH Polarization

HV polarization shows **higher RFI contamination** than HH:
- HV has 80.88% remaining RFI after bounding (vs 46.19% for HH)
- HV recovered only 19.10% of CPIs (vs 53.81% for HH)
- This suggests HV is more severely affected by RFI in the Los Angeles region
